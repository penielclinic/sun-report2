...
const STEPS = {
  sun_leader: [
    ...
    "성경을 다 마치신 순원이 있으면 이름을 눌러 <b>성경통독 완료</b>·<b>성경필사 완료</b>에 체크하세요. <b>다 마친 그 주에 한 번만</b> 체크하면 돼요.",
    "헌금 합계와 특별보고(기도제목)를 적고 <b>제출하기</b>를 누르면 끝!",
    "제출한 뒤에도 <b>수정하기</b>로 언제든 고쳐서 다시 제출할 수 있어요. 선교회장님이 이미 보고서를 냈어도 괜찮아요 — 합계가 자동으로 맞춰지고 선교회장님께 알림이 가요.",
  ],
  mission_leader: [
    ...
    "<b>성경통독·필사</b>는 순장님들이 체크한 내용이 저절로 모여요. 따로 적지 않으셔도 목사님께 함께 보고돼요.",
    "<b>제출하기</b>를 누르면 담임목사님께 알림이 가요. 제출 후 순장님이 보고서를 고치면 알림이 오고 합계가 자동으로 맞춰지니, 확인하고 <b>수정하기 → 다시 제출</b>하면 돼요.",
  ...
  pastor: [
    ...
    "<b>성경통독·필사</b>를 마친 분들은 선교회장님이 보고서를 내면 홈과 전체 통계 현황에 자동으로 올라가요.",
